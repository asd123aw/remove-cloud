...
def top_20(arr_2d,num_sim):
    ...
    # 对非零元素值进行排序并获取排序后的前20个元素的索引
    sorted_indices = np.argsort(non_zero_values)[:num_sim]
    # 将这些索引对应的位置在原二维数组中设为1，其余位置设为0
    # 首先将整个数组设为0
    arr_2d[:] = 0
    # 然后将选中的位置设为1
...
# =============================================================================
#     my_result = A*clear_img + B + cloud_img*(1-mask)
#     
#     time_result = clear_img*mask + time_dif + cloud_img*(1-mask)
# =============================================================================
    return my_result,time_result,sim_pixels
# =============================================================================
# maks_path = r'C:/Users/Administrator/Desktop/去云算法小论文/实验/去云/1allmask.tif'
# ref_img_path=r"C:/Users/Administrator/Desktop/去云算法小论文/实验/去云/20221019_band5.tif"   #参考影响
# tar_img_path=r"C:/Users/Administrator/Desktop/去云算法小论文/实验/去云/20220929_band5.tif"   #目标影响   ref_img_path
# =============================================================================
...
# mask_loca =[565,432]
# cloud_x,cloud_y = mask_loca
# nspi_loc = nspi_sim_pix(cloud_img,4,cloud_x,cloud_y)
# for i in range(cloud_img.shape[0]):
#          
#     my_result,time_result ,sim_pixels = dc(cloud_img[i],clear_img[i],mask,jizhun_class,cloud_class,mask_loca,nspi_loc)
#     my_result_[i,cloud_x,cloud_y] = my_result
#     time_result_[i,cloud_x,cloud_y] = time_result
# =============================================================================
